...
config.keys = {
  ...
  -- REMOVED CONFLICTING L KEY - using plugin default Alt+L for load session
...
-- ============================================================================
-- SESSION PERSISTENCE SETUP (CORRECTED)
-- ============================================================================
-- Apply the sessions plugin with its default keybindings
-- Default keybindings from the plugin:
-- Alt+S: Save session
-- Alt+L: Load session  
